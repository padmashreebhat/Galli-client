...
////////////////////// SET People information from Database //////////////////////////
function set_resident_info_db($conn, $residentinfo){
	...
	$query ="INSERT INTO AptUser (email,fname,lname,AptNum)
VALUES ('$residentinfo[0]','$residentinfo[1]','$residentinfo[2]','$residentinfo[3]');";
...
if($_GET){
	$residentinfo=array();
	$residentinfo[] = $_GET['email'];
	$residentinfo[] = $_GET['fname'];
	$residentinfo[] = $_GET['lname'];
	$residentinfo[] = $_GET['AptNum'];
	$residentinfo[] = $_GET['AptName'];
}
else{
	$username = $argv[1];
}
...
$conn = open_db_connection();	
 set_resident_info_db($conn, $residentinfo);
